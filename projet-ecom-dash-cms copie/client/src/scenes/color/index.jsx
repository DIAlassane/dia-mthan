...
const Color = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/management/color/${storeId}`)
      .then((result) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`http://localhost:4000/management/color/${id}`, {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <Header title="Color" subtitle="Liste Couleurs" />
      <Box>
        <Link
          to="/addcolor"
          style={{
        ...
        {activeId && <UpdateColor id={activeId} />}{" "}
